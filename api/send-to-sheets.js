...
const tradesmenEmails = {
  builder: ['danbricks18@gmail.com', 'builder2@example.com'],
  electrician: ['electrician1@example.com', 'electrician2@example.com'],
  plumber: ['plumber1@example.com', 'plumber2@example.com'],
  painter: ['painter1@example.com', 'painter2@example.com'],
  roofer: ['roofer1@example.com', 'roofer2@example.com'],
  landscaper: ['landscaper1@example.com', 'landscaper2@example.com'],
  heating: ['heating1@example.com', 'heating2@example.com'],
...
export default async function handler(req, res) {
  ...
  try {
    ...
    // 3. Send email to relevant tradesmen
