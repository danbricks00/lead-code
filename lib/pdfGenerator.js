...
export async function generateQuotePDF(quoteData) {
  ...
  try {
    ...
    // Since room data isn't needed on the PDF, just provide a placeholder message
    html = html.replace('{{ROOM_ROWS}}', '<tr><td colspan="2" style="text-align: center;">Room details available on quote submission page</td></tr>');
