  ...
  try {
    ...
    try {
      if (process.env.GOOGLE_PROJECT_ID && process.env.GOOGLE_PRIVATE_KEY) {
        ...
        console.log('Google Sheets credentials not configured - skipping sheets update');
      }
    } catch (sheetsError) {
    ...
    try {
      if (process.env.GMAIL_USER && process.env.GMAIL_APP_PASSWORD) {
        ...
        console.log('Gmail credentials not configured - skipping customer email');
      }
    } catch (emailError) {
    ...
    try {
      if (process.env.GMAIL_USER && process.env.GMAIL_APP_PASSWORD) {
        ...
        console.log('Gmail credentials not configured - skipping tradesman emails');
      }
    } catch (emailError) {
