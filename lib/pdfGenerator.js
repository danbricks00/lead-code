...
export async function generateQuotePDF(quoteData) {
  ...
  if (quoteData.pdfData) {
    ...
    data = {
      ...
      tradespersonEmail: quoteData.pdfData.tradesperson?.email || quoteData.tradePersonEmail,
      tradespersonPhone: quoteData.pdfData.tradesperson?.phone || quoteData.tradePersonPhone,
      tradespersonLicense: quoteData.pdfData.tradesperson?.license || quoteData.tradePersonLicense,
      // Financial data
