"use strict";(()=>{var e={};e.id=6947,e.ids=[6947],e.modules={9993:e=>{e.exports=require("googleapis")},145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},5184:e=>{e.exports=require("nodemailer")},4770:e=>{e.exports=require("crypto")},6249:(e,t)=>{Object.defineProperty(t,"l",{enumerable:!0,get:function(){return function e(t,o){return o in t?t[o]:"then"in t&&"function"==typeof t.then?t.then(t=>e(t,o)):"function"==typeof t&&"default"===o?t:void 0}}})},2652:(e,t,o)=>{o.r(t),o.d(t,{config:()=>m,default:()=>h,routeModule:()=>f});var r={};o.r(r),o.d(r,{default:()=>g});var i=o(1802),n=o(7153),s=o(6249),a=o(5367),l=o(5184),d=o.n(l),c=o(4770),u=o.n(c);async function p(e,t,o){let r=process.env.GOOGLE_SHEET_ID;if(!r)throw console.error("❌Sheets Config Error: GOOGLE_SHEET_ID is not set."),Error("Google Sheet ID is not configured.");try{console.log(`Attempting to append row to tab: ${t}`),await e.spreadsheets.values.append({spreadsheetId:r,range:`${t}!A1`,valueInputOption:"USER_ENTERED",insertDataOption:"INSERT_ROWS",requestBody:{values:[o]}}),console.log(`✅ Successfully appended row to tab: ${t}`)}catch(e){throw console.error(`❌ Google Sheets API Error while appending to ${t}:`,e.message),e.response&&e.response.data&&console.error("Full Sheets API response:",e.response.data),Error("Failed to write data to Google Sheet.")}}async function g(e,t){if(console.log("\n--- New Lead Intake Request ---"),console.log("Timestamp:",new Date().toISOString()),console.log("Request Body Received:",JSON.stringify(e.body,null,2)),"POST"!==e.method)return t.status(405).json({success:!1,error:"Method not allowed"});let{customerName:o,customerEmail:r,customerPhone:i,serviceType:n,rooms:s,area:l,suburb:c,timeline:g,budget:h,specificDetails:m,projectDetails:f,projectSize:E,isUnlistedSuburb:b,suburbAdditionalInfo:S}=e.body;if(!o||!r)return console.error("Validation Error: Missing customerName or customerEmail."),t.status(400).json({success:!1,error:"Missing required fields"});try{let e=u().randomBytes(6).toString("hex"),E=u().randomBytes(6).toString("hex"),S=(0,a.r)();console.log("Appending data to 'Leads' tab with exact schema..."),await p(S,"Leads",[e,o,r,i||"",n||"Underfloor Heating",JSON.stringify(s||[]),l||"",c||"",h||"",g||"",m||f||"",new Date().toLocaleString("en-NZ",{timeZone:"Pacific/Auckland",day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}),"","New Lead"]),console.log("Appending data to 'Quotes' tab with exact format..."),await p(S,"Quotes",[new Date().toLocaleString("en-NZ",{timeZone:"Pacific/Auckland",day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"}),E,e,"","","","Quote Pending","Not Submitted","Not Required","","","","","","","","","","","","","","","","","","",o,r,i||"",n||"Underfloor Heating",`${c||""}${c&&l?", ":""}${l||""}`,g||"",h||"",JSON.stringify(s||[]),""]),console.log("Step 3: Preparing email content...");let v=process.env.NEXT_PUBLIC_BASE_URL;if(!v)throw console.error("❌ CRITICAL: NEXT_PUBLIC_BASE_URL is not defined."),Error("Server configuration error: base URL not set.");let w=v.replace(/^(https?:\/\/)/,""),$=Date.now(),A=u().createHmac("sha256",process.env.QUOTE_LINK_SECRET).update(`${E}|${$}`).digest("hex"),L=`https://${w}/quote-submit/${E}?ts=${$}&token=${A}`;console.log("Constructed quote link:",L);let P=s&&s.length>0?`<li><b>Room Details:</b><ul>${s.map(e=>`<li>${e.name||"Unnamed"}: ${e.dimensions||"N/A"}</li>`).join("")}</ul></li>`:"",y=b?`
    ...
    `:"",_=`
      ...
      <ul>
        ...
        ${P}
        ${b?`<li><b>⚠️ Unlisted Suburb:</b> ${c} (not in service list)</li>`:""}
      </ul>
    `,I=`
      <hr>
