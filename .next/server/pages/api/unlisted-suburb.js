"use strict";(()=>{var e={};e.id=8578,e.ids=[8578],e.modules={9993:e=>{e.exports=require("googleapis")},145:e=>{e.exports=require("next/dist/compiled/next-server/pages-api.runtime.prod.js")},5184:e=>{e.exports=require("nodemailer")},6249:(e,o)=>{Object.defineProperty(o,"l",{enumerable:!0,get:function(){return function e(o,t){return t in o?o[t]:"then"in o&&"function"==typeof o.then?o.then(o=>e(o,t)):"function"==typeof o&&"default"===t?o:void 0}}})},6250:(e,o,t)=>{t.r(o),t.d(o,{config:()=>u,default:()=>d,routeModule:()=>c});var r={};t.r(r),t.d(r,{default:()=>a});var s=t(1802),i=t(7153),n=t(6249),l=t(5367);async function a(e,o){if(console.log("✅ Loaded API unlisted-suburb.js"),"POST"!==e.method)return o.setHeader("Allow",["POST"]),o.status(405).json({success:!1,error:`Method ${e.method} Not Allowed. Use POST method.`});try{let{suburbName:r,additionalInfo:s,customerName:i,customerEmail:n,customerPhone:a,leadId:d,serviceType:u,rooms:c,area:g,budget:p,timeline:m}=e.body;if(!r||!i||!n)return o.status(400).json({success:!1,error:"Missing required fields: suburbName, customerName, customerEmail"});console.log(`🚨 UNLISTED SUBURB DETECTED: ${r}`),console.log(`📋 Customer: ${i} (${n})`),console.log(`📋 Lead ID: ${d}`),console.log(`📋 Additional Info: ${s||"None provided"}`);let f=(()=>{let e=new Date;return new Date(e.toLocaleString("en-US",{timeZone:"Pacific/Auckland"})).toLocaleString("en-NZ",{day:"2-digit",month:"2-digit",year:"numeric",hour:"2-digit",minute:"2-digit"})})();try{let e=(0,l.r)(),o=(0,l.D)();if(o){console.log("\uD83D\uDCCA Logging unlisted suburb to Google Sheets...");let t=[f,d||"N/A",r,s||"",i,n,a||"",u||"Underfloor Heating",g||"",p||"",m||"",JSON.stringify(c||[]),"Pending Review","","",""];await e.spreadsheets.values.append({spreadsheetId:o,range:"UnlistedSuburbs!A:P",valueInputOption:"USER_ENTERED",requestBody:{values:[t]}}),console.log("✅ Unlisted suburb logged to Google Sheets")}}catch(e){console.error("❌ Failed to log to Google Sheets:",e.message)}try{let e=t(5184).createTransporter({service:"gmail",auth:{user:process.env.GMAIL_USER,pass:process.env.GMAIL_APP_PASSWORD}}),o={from:process.env.GMAIL_USER,to:process.env.ADMIN_EMAIL||"danbricks18@gmail.com",subject:`🚨 UNLISTED SUBURB: ${r} - Lead from ${i}`,html:`
          <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
            ...
            <div style="background-color: #f8f9fa; border: 1px solid #dee2e6; padding: 15px; border-radius: 5px; margin: 20px 0;">
              ...
              <p><strong>Phone:</strong> ${a||"Not provided"}</p>
              <p><strong>Lead ID:</strong> ${d||"N/A"}</p>
            </div>
