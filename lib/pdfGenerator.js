...
export async function generateQuotePDF(quoteData) {
  ...
  html = html.replace(/{{LABOUR_HOURS}}/g, labourHours.toString());
  ...
  html = html.replace(/{{MATERIALS_QUANTITY}}/g, materialsQuantity.toString());
  ...
  html = html.replace(/{{TRAVEL_DISTANCE}}/g, travelDistance.toString());
