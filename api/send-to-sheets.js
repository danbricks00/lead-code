...
export default async function handler(req, res) {
  ...
  try {
    ...
    try {
      ...
      // Email notifications are now handled by lead-notification.js to avoid duplicates
      console.log('📧 Email notifications will be handled by lead-notification.js');
      tradesmanNotified = true;
    } catch (error) {
      console.error('❌ Error in notification setup:', error.message);
    }
