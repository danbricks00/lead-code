...
// Function to get the current token set from environment or storage
async function getCurrentTokenSet() {
  ...
  // If no environment variable, try to get from stored token
  try {
    return await getStoredXeroTokenSet();
  } catch (error) {
